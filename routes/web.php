...
Route::middleware(['auth', 'committee.readonly'])->group(function () {
    ...
    Route::get('/api/attendees/{attendee}/transactions', [EventController::class, 'apiAttendeeTransactions'])->name('api.attendees.transactions');
    ...
    Route::get('/digital-cards/recipients/{recipient}/pdf', [DigitalCardController::class, 'recipientPdf'])->name('cards.recipient.pdf');
    ...
    Route::middleware('not.committee')->group(function () {
        ...
        Route::post('/messaging/templates/usage', [MessagingController::class, 'templateUsage'])->name('messaging.templates.usage');
