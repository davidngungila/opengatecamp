...
@section('title', 'Event Settings — Settings — OpenGate Camp Connect')
  ...
  <div class="solid-card" style="margin-top:18px">
    ...
    <form method="POST" action="{{ route('settings.digital-card') }}" enctype="multipart/form-data">
      ...
      <div class="form-grid">
        ...
        <div class="field full"><label>Secretary Phone</label><input type="text" name="digital_card_leader_secretary_phone" value="{{ $s('digital_card.leader_secretary_phone') }}" placeholder="0756 112 102"></div>
        <div class="field full"><label>Treasurer Phone</label><input type="text" name="digital_card_leader_treasurer_phone" value="{{ $s('digital_card.leader_treasurer_phone') }}" placeholder="0756 112 102"></div>
