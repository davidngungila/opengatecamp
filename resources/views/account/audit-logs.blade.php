...
@section('title', 'Audit Logs — OpenGate Camp Connect')
    ...
    <div class="table-scroll">
      <table class="data-table">
        ...
        <tbody>
          ...
          @empty
          <tr><td colspan="7"><div class="empty-state"><h3>No activity found</h3><p>Try adjusting your filter or search.</p></div></td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
