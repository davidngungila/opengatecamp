...
<head>
<meta charset="UTF-8">
<title>Timetable — Open Gate Camp Mission</title>
<style>
...
<div class="paper">
  <div class="head">
    <div>
      <div class="logo">Open Gate Camp Mission</div>
      <h1>
  ...
  <div class="foot">Generated by Open Gate Camp Mission · {{ $today->format('d M Y H:i') }}</div>
</div>
</body>
</html>