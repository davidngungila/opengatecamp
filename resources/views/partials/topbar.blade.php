  ...
  <div class="topbar-right">
    ...
    <div style="position:relative">
      <button type="button" class="user-chip" data-panel-toggle="userPanel" onclick="togglePanel('userPanel')">
        ...
        <div class="avatar">{{ collect(explode(' ', $u?->name ?? 'OG'))->map(fn($w) => mb_substr($w,0,1))->take(2)->implode('') }}</div>
        <div class="u-meta">
      ...
      <div class="dropdown-panel" id="userPanel">
        <a class="menu-item" href="{{ url('/settings?tab=general') }}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> My Profile</a>
        ...
        <a class="menu-item" href="{{ url('/settings?tab=security') }}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg> Security</a>
        <a class="menu-item" href="{{ url('/settings?tab=audit') }}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> Activity</a>
