...
<head>
    ...
    <title>Open Gate Camp Connect — Digital Card</title>
    ...
    <style>
        ...
        /* =========================================================
           PHP VARIABLES (background, colors, etc.)
        ========================================================= */
        @php
            $bgUrl = null;
        ...
        * {
        ...
        /* =========================================================
           SIGNATURES — REDESIGNED (CLEAN & SIMPLE)
        ========================================================= */
        .signatures {
            width: 100%;
            max-width: 1080px;
        ...
        .signature-row.coordinator .signature-item {
            flex: 0 1 100%;
            max-width: 400px;
        }

        .signature-row.two-col .signature-item {
            flex: 1 1 200px;
            max-width: 320px;
        }
    ...
    <div class="pdf-page">
        ...
        <div class="content">
            ...
            <div class="campaign-header">
                ...
                <div class="large">SEASON THREE</div>
            </div>
            ...
            @if($qrData)
                <div class="qr-section">
                    <div class="qr-title">Scan QR Code kuchangia Online</div>
                    <div class="qr">
                        <img src="{{ $qrData }}" alt="Scan to contribute">
                    </div>
                </div>
            @endif
            ...
            <div class="signatures">
                ...
                <!-- MRATIBU WA TUKIO (full width, centered) -->
                <div class="signature-row coordinator">
                    <div class="signature-item">
                        <div class="sign-line-wrapper">
                            @if($leadEventStamp)
                                <div class="sign-stamp">
                                    <img src="{{ asset('storage/'.$leadEventStamp) }}" alt="Event Coordinator stamp">
                                </div>
                            @else
                ...
                <!-- KATIBU + MWEKA HAZINA (same row, two columns) -->
                <div class="signature-row two-col">
                    <!-- Katibu -->
                    <div class="signature-item">
                        <div class="sign-line-wrapper">
                            @if($leadSecStamp)
                                <div class="sign-stamp">
                                    <img src="{{ asset('storage/'.$leadSecStamp) }}" alt="Secretary stamp">
                                </div>
                            @else
                                <div class="sign-line"></div>
                            @endif
                    ...
                    <div class="signature-item">
                        <div class="sign-line-wrapper">
                            @if($leadTreStamp)
                                <div class="sign-stamp">
                                    <img src="{{ asset('storage/'.$leadTreStamp) }}" alt="Treasurer stamp">
                                </div>
                            @else
                                <div class="sign-line"></div>
                            @endif
            ...
            ====================================================== --}}
            <div class="footer">
                <div class="contact">OPEN GATE CAMP SEASON THREE</div>
                <div class="bottom">
                    {{ $card->card_no }}
