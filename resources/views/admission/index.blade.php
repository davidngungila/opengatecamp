...
<style>
  ...
  .scan-card,.result-card{max-width:560px;margin-left:auto;margin-right:auto;}
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  function openAdm(row){
    ...
    document.getElementById('admPaid').textContent = (d.fee ? 'TZS ' + d.fee : '—') + (d.paid && d.paid !== '0' ? ' paid out of' : ' / Fee') + ' TZS ' + d.paid;
